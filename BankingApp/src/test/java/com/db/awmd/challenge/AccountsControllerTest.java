...
public class AccountsControllerTest {
	...
	public void transferAmount() throws Exception {
		...
		Account toAccount = new Account(toAccountId, new BigDecimal("145.65"));
		this.accountsService.createAccount(toAccount);
		
		this.mockMvc.perform(get("/v1/accounts/transfer?fromAccountId=" + fromAccountId+"&toAccountId="+toAccountId+"&amount=100")).andExpect(status().isOk());
